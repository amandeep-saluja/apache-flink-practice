...
public class Aggregation
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<String> data = env.readTextFile("/home/ubuntu/Desktop/Data/flink_data/avg1");
        ...
        mapped.keyBy(0).sum(3).writeAsText("/home/ubuntu/Desktop/out1");

        mapped.keyBy(0).min(3).writeAsText("/home/ubuntu/Desktop/out2");

        mapped.keyBy(0).minBy(3).writeAsText("/home/ubuntu/Desktop/out3");

        mapped.keyBy(0).max(3).writeAsText("/home/ubuntu/Desktop/out4");

        mapped.keyBy(0).maxBy(3).writeAsText("/home/ubuntu/Desktop/out5");
        // execute program
