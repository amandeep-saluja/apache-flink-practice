package com.example.flink.joinExample;
...
public class InnerJoinExample
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataSet<Tuple3<Integer, String, String>> joined = locationSet.join(personSet,JoinHint.OPTIMIZER_CHOOSES).where(0) .equalTo(0)
