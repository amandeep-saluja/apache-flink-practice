package com.example.flink.splitFile;
...
public class SplitOperation {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> text = env.readTextFile("/home/ubuntu/oddeven");
        ...
        SplitStream<Integer> evenOddStream = text.map(new MapFunction<String, Integer>() {
                ...
                .split(new OutputSelector<Integer>() {
                    public Iterable<String> select(Integer value) {
                        ...
                        if (value % 2 == 0) out.add("even");              // label element  --> even 454   odd 565 etc
                        else out.add("odd");
                        return out;
                    }
                });
        ...
        evenData.writeAsText("/home/ubuntu/even");
        oddData.writeAsText("/home/ubuntu/odd");
